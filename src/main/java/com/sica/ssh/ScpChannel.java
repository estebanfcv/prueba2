...
public class ScpChannel extends SessionChannelClient {
  ...
  private SshClient ssh;
    ...
    private ChannelEventListener eventListener;
         ...
         * @since 0.2.0
         */
        public ScpChannel(SshClient ssh, boolean verbose,
         ...
         * @since 0.2.0
         */
        public ScpChannel(File cwd, SshClient ssh, boolean verbose,
                         ChannelEventListener eventListener) {
          this.ssh = ssh;
          this.cwd = cwd;
     ...
     * 121
     * <p>
     * 122 * Gets a remote file as an <code>java.io.InputStream</code>. 123
     *
     * </p>
     * 124 * 125 * @param remoteFile remote file name 126 * 127 * @return stream
     * 128 * 129 * @throws IOException on any error 130
     *
     * @param remoteFile
     * @param ssh
     * @return
     ...
     */
    public InputStream get(String remoteFile, SshClient ssh) throws IOException {
        InputStream is;
        ScpChannel scp = new ScpChannel("scp " + "-f " + (verbose ? "-v " : "")
                + remoteFile);
        scp.close();
